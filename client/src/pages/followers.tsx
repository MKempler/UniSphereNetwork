...
export default function Followers() {
  ...
  // Fetch the followers list once we have the profile user's ID
          ...
          <div className="divide-y">
            {isLoading ? (
              ...
              followers.map((follower) => (
                <div key={follower.id} className="p-4 flex items-center">
                  ...
                  <div className="ml-3 flex-1">
                    <div className="flex items-center">
                      <Link href={`/profile/${follower.username}`}>
                        <a className="font-semibold hover:underline">{follower.name}</a>
                      </Link>
                      {follower.isVerified && (
